...
if __name__ == '__main__':
    ...
    bf = open(settings.EAR_GAIT_URL+"body_features.txt", "a")  # 비율과 각도 쓸 파일 입력
    while True:
        ...
        # 레이블 0:오윤석 , 1:임혜진, 2:이동준, 3:이동훈, 4:손정효 // test에선 입력 받지 않는다 fetures 또한 11길이의 배열
        features[11] = 3
        ...
        filedata = "%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f\n" \
                    % (
        ...
        if (cv2.waitKey(1) == 27) | ((time.time() - timestart > 3) & ifstart == 1):
            break
