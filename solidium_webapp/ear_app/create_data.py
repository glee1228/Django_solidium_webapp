...
if __name__ == "__main__":
    ...
    path_1=settings.EAR_URL+"Ear_image/Train/Before_preprocess/"
    path_2=settings.EAR_URL+"Ear_image/Train/After_preprocess/"
    path_t1=settings.EAR_URL+"Ear_image/Train/Before_preprocess/Validation_data/"
    path_t2=settings.EAR_URL+"Ear_image/Train/After_preprocess/Validation_data/"
    cnt=0
